...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.error_lcd.setDigitCount(3)
        ...
        self.actual_pos_lcd.setDigitCount(3)
        ...
        self.jog_down_fast.clicked['bool'].connect(
            self.start_run_button.setDisabled)
        self.jog_down_slow.clicked['bool'].connect(
            self.start_run_button.setDisabled)
        self.jog_up_slow.clicked['bool'].connect(
            self.start_run_button.setDisabled)
        self.jog_up_fast.clicked['bool'].connect(
            self.start_run_button.setDisabled)
        self.jog_stop.clicked['bool'].connect(self.start_run_button.setEnabled)
        self.jog_down_fast.clicked['bool'].connect(
            self.stop_run_button.setDisabled)
        self.jog_down_slow.clicked['bool'].connect(
            self.stop_run_button.setDisabled)
        self.jog_up_slow.clicked['bool'].connect(
            self.stop_run_button.setDisabled)
